...
public class PrayTime {
    ...
    public enum CalculationJuristicMethod{
    ...
    public static void main(String[] args) {
        double latitude = 41.926821;  //41.926821, -73.996886
        double longitude = -73.996886;
        double timezone = -4;
    ...
    public static void testTime(String[] s, int timezone){
        if(s[3].startsWith("-")){
        	if(s[3].charAt(1) == '0'){
